...
{
	public class GenerateSegmentOBX
	{
		public string CreateOBXSegment(ObservationResult a_mObservationResult)
		{
			string sErrorMsg;
		...
		public bool ValidateOBXSegment(string a_sMessage, out string a_sErrorMsg)
		{
			...
			if (!string.IsNullOrEmpty(a_sMessage))
			{
				...
				{
					a_sErrorMsg = "Invalid OBX Segment: Incomplete Data";
					return false;
				}
			...
			{
				a_sErrorMsg = "Invalid OBX Segment: Empty Data";
				return false;
			}
			return true;
		}
